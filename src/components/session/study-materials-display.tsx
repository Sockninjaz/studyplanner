...
export default function StudyMaterialsDisplay({ exam }: StudyMaterialsDisplayProps) {
  ...
  return (
    <div className="mt-8 p-4 bg-gray-50 dark:bg-slate-800 rounded-lg">
      <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-4">Study Materials for {exam.subject}</h3>
      
      {/* Progress Overview */}
      <div className="mb-4 p-3 bg-white dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-slate-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {exam.studyMaterials.map((material, index) => (
          <div key={index} className="bg-white dark:bg-slate-900 p-3 rounded-lg border border-gray-200 dark:border-slate-700">
            <div className="flex justify-between items-start">
              <div className="flex-1">
                <p className="font-medium text-gray-900 dark:text-slate-100">{material.chapter}</p>
                <div className="mt-2 flex gap-3 text-xs text-gray-500 dark:text-slate-400">
